...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        private val MIGRATION_27_28 = object : Migration(27, 28) {
            override fun migrate(database: SupportSQLiteDatabase) {
                val cols = listOf("height", "weight", "caste", "subCaste", "familyDetails", "educationDetails")
                cols.forEach { col ->
                    try {
                        database.execSQL("ALTER TABLE employees ADD COLUMN $col TEXT")
                    } catch (e: Exception) {
                        // ignore
                    }
                }
            ...
            INSTANCE ?: synchronized(this) {
                val instance = Room.databaseBuilder(
                    ...
                    .addMigrations(
                        ...
                        MIGRATION_18_19, MIGRATION_27_28
                    ) // ✅ Keep user data on update
