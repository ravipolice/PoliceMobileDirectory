...
sealed class GoogleSignInUiEvent {
    ...
    data class RegistrationPending(val email: String) : GoogleSignInUiEvent()
    data class RegistrationRejected(val email: String, val reason: String) : GoogleSignInUiEvent()
